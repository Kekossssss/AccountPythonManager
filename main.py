...
from Utils.interactive_mode import interactive_mode
...
def main(args):
    ...
    if (args.interactive_mode):
        ...
        for i in range(len(args.folders)):
            ...
            my_accounts.generate_monthly(summary_file_type=args.extension_format)
...
if __name__=="__main__":
    ...
    parser.add_argument('-i', "--interactive_mode", help="Used to access data in interactive mode", action='store_true')
